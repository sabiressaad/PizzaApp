...
public class ListPizzaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (produitService.findAll().isEmpty()) {
            initialiserDonneesPizza();
        }

        listProduits = produitService.findAll();
        Log.d("ListPizzaActivity", "Nombre de pizzas: " + listProduits.size());

        listView = findViewById(R.id.liste);
        PizzaAdapter adapter = new PizzaAdapter(this, listProduits);
        listView.setAdapter(adapter);

        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Produit selectedProduit = listProduits.get(position);
                Log.d("ListPizzaActivity", "Clic sur: " + selectedProduit.getNom() + ", ID: " + selectedProduit.getId());

                Intent intent = new Intent(ListPizzaActivity.this, DetailPizzaActivity.class);

                intent.putExtra("PIZZA_ID", selectedProduit.getId());

            }
        });

        findViewById(R.id.filterFavoritesButton).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.shareAllButton).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                shareAllRecipes();
            }
    ...
    private void shareAllRecipes() {
        StringBuilder content = new StringBuilder("Mes recettes de pizza préférées:\n\n");

        for (Produit p : produitService.findAll()) {
            if (showFavoritesOnly) {
                if (p.isFavori()) {
                    content.append("- ").append(p.getNom()).append(" (").append(p.getDuree()).append(")\n");
                }
            } else {
                content.append("- ").append(p.getNom()).append(" (").append(p.getDuree()).append(")\n");
            }
        ...
        shareIntent.putExtra(Intent.EXTRA_SUBJECT, "Mes recettes de pizza");
        shareIntent.putExtra(Intent.EXTRA_TEXT, content.toString());
        startActivity(Intent.createChooser(shareIntent, "Partager mes recettes via"));
    }


    private void initialiserDonneesPizza() {
        produitService.create(new Produit("BARBECUED CHICKEN PIZZA", 3, R.mipmap.pizza1, "35 min",
        ...
        produitService.create(new Produit("BRUSCHETTA PIZZA", 5, R.mipmap.pizza2, "35 min",
        ...
        produitService.create(new Produit("SPINACH PIZZA", 2, R.mipmap.pizza3, "25 min",
        ...
        produitService.create(new Produit("DEEP-DISH SAUSAGE PIZZA", 8, R.mipmap.pizza4, "45 min",
        ...
        produitService.create(new Produit("HOMEMADE PIZZA", 4, R.mipmap.pizza5, "50 min",
        ...
        produitService.create(new Produit("PESTO CHICKEN PIZZA", 3, R.mipmap.pizza6, "50 min",
        ...
        produitService.create(new Produit("LOADED MEXICAN PIZZA", 3, R.mipmap.pizza7, "30 min",
        ...
        produitService.create(new Produit("BACON CHEESEBURGER PIZZA", 2, R.mipmap.pizza8, "20min",
        ...
        produitService.create(new Produit("PIZZA MARGHERITA", 1, R.mipmap.pizza9, "30 min",
        ...
        produitService.create(new Produit("PEPPERONI-SAUSAGE STUFFED PIZZA", 5, R.mipmap.pizza10, "45 min",
    ...
    private void toggleFavoritesFilter() {
        ...
        Log.d("ListPizzaActivity", "Affichage des favoris: " + showFavoritesOnly);
        ...
        if (showFavoritesOnly) {
            ...
            filteredList = produitService.findAll();
        }
        ...
        Toast.makeText(this,
                showFavoritesOnly ? "Affichage des favoris" : "Affichage de toutes les pizzas",
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("ListPizzaActivity", "onActivityResult - requestCode: " + requestCode + ", resultCode: " + resultCode);
    ...
    private void refreshList() {
        Log.d("ListPizzaActivity", "Rafraîchissement de la liste");
